...
namespace GrecosQuestionnaire.Migrations
{
    ...
    [Migration("20200526185004_Hotel36")]
    partial class Hotel36
    {
            ...
            modelBuilder.Entity("GrecosQuestionnaire.Models.ResponseItemModel", b =>
                {
                    ...
                    b.HasOne("GrecosQuestionnaire.Models.ResponseModel", "ResponseId")
                        .WithMany()
                        .HasForeignKey("ResponseIdId");
                });
