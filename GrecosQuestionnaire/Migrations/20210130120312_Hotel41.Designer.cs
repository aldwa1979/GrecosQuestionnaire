...
namespace GrecosQuestionnaire.Migrations
{
    ...
    [Migration("20210130120312_Hotel41")]
    partial class Hotel41
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrecosQuestionnaire.Models.QuestionItemItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("QuestionItemItems");
                });

            modelBuilder.Entity("GrecosQuestionnaire.Models.ResponseItemItemModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("QuestionItemItemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("QuestionItemItemId");

                    b.HasIndex("ResponseItemId");

                    b.ToTable("ResponseItemItems");
                });
            ...
            modelBuilder.Entity("GrecosQuestionnaire.Models.ResponseItemItemModel", b =>
                {
                    b.HasOne("GrecosQuestionnaire.Models.QuestionItemItem", "QuestionItemItem")
                        .WithMany()
                        .HasForeignKey("QuestionItemItemId");

                    b.HasOne("GrecosQuestionnaire.Models.ResponseItemModel", "ResponseItem")
                        .WithMany()
